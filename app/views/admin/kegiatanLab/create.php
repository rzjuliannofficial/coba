...
<h1 class="text-2xl font-bold mb-6">Tambah Kegiatan Lab</h1>
...
<form action="/admin/KegiatanLab/store" method="POST" enctype="multipart/form-data"
    ...
    <input type="date" name="tanggal_kegiatan" class="w-full p-2 border rounded mb-4">

    <label class="block font-semibold mb-1">Deskripsi</label>
    <textarea name="deskripsi" class="w-full p-2 border rounded mb-4"></textarea>

    <label class="block font-semibold mb-1">Upload Dokumentasi</label>
